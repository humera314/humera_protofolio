    ...
    >
      ...
      <div className="container mx-auto px-4 relative z-10">
        ...
        >
          ...
          >
             <a
                href="https://credentials.databricks.com/e4824f24-23b6-4e26-a8ca-eee8566f5010#acc.Sb7MY3Aw" // 🔗 replace with your cert link
                target="_blank"
          ...
          <div className="mt-16 relative">
            {["Databricks", "Microsoft", "LinkedIn", "AWS"].map((tech, index) => (
              <motion.div
                key={tech}
